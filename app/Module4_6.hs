...
-- по сути упаковка уже существующего типа, поэтому не надо делать pattern matching компилятору, так
-- как вариант pattern matching всегда один - и он всегда будет правильным
