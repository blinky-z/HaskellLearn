...
-- непосредественно с самими контейнерами: (f a -> f b) (ведь все функции в хаскеле - функции одного аргумента)
-- в такой функции первым параметром является контейнер, и мы можем работать не с базовыми типами, а с контейнерами
